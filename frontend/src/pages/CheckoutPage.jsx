    ...
    await Promise.all(
      items.map(async (item) => {
        ...
        try {
          ...
          console.error("Không xóa được sản phẩm:", productId, err);
        }
      }),
    );
  };
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div
                  ...
                  className={`cursor-pointer p-4 border rounded-xl flex items-center gap-3 transition-all ${paymentMethod === "cod" ? "border-blue-500 bg-blue-50 ring-1 ring-blue-500" : "border-gray-200 hover:bg-gray-50"}`}
                >
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-blue-100 sticky top-10">
              ...
              <div className="border-t pt-4 space-y-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-4 mt-6 rounded-xl font-bold text-white flex justify-center items-center gap-2 transition-all shadow-lg ${loading ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700 shadow-blue-100 active:scale-[0.98]"}`}
                >
                  {loading ? (
                ...
                <p className="text-[10px] text-center text-gray-400 mt-4 italic">
                  Bằng việc nhấn đặt hàng, bạn đồng ý với các điều khoản của DHD
                  - GlassesShop
                </p>
              </div>
            </div>
