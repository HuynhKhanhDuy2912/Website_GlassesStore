                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-baseline mb-1">
                      <h4
                        className={`text-sm truncate max-w-[160px] ${isUnread ? "font-bold text-gray-900" : "font-medium text-gray-700"}`}
                      >
                        {displayName}
                      </h4>
                      <span
                        className={`text-[10px] ${isUnread ? "text-blue-600 font-bold" : "text-gray-400"}`}
                      >
                    ...
                    <div className="flex justify-between items-center">
                      <div
                        className={`text-xs truncate max-w-[85%] ${isUnread ? "text-gray-800 font-medium" : "text-gray-400"}`}
                      >
                        {lastMsg?.message ? (
                          <span>{lastMsg.message}</span>
                        ) : (
                          <span className="flex items-center gap-1 italic text-blue-500">
            ...
            <>
                ...
                {selectedTicket.conversation.map((msg, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 shadow-sm ${isMe ? "bg-blue-600 text-white" : "bg-white text-blue-600 border border-gray-200"}`}
                        >
                          {isMe ? (
                            <ShieldCheck size={16} />
                          ) : (
                        ...
                        <div>
                          <div
                            className={`p-3 rounded-2xl text-sm shadow-sm overflow-hidden ${isMe ? "bg-blue-600 text-white rounded-tr-none" : "bg-white text-gray-700 border border-gray-200 rounded-tl-none"}`}
                          >
                            {msg.image && (
                              <div className="mb-2">
                                <img
                          ...
                          <div
                            className={`text-[10px] mt-1 opacity-60 ${isMe ? "text-right" : "text-left"}`}
                          >
              ...
              <div className="p-4 bg-white border-t border-gray-200">
                ...
                >
                  ...
                  <input
                    type="text"
                    className="flex-1 p-3 border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:border-blue-500 transition"
                  ...
                  <button
                    type="submit"
                    disabled={
                      sending || (!replyMessage.trim() && !selectedFile)
                    }
                    className="bg-blue-600 text-white p-3 rounded-xl hover:bg-blue-700 transition shadow-lg disabled:bg-gray-300"
                  >
                    {sending ? (
